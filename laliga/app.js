...
const setupSection = document.getElementById('setup-section');
    ...
    if (tbody) tbody.innerHTML = '<tr><td colspan="12" class="text-center py-8 text-gray-400">Loading Laliga...</td></tr>';
                ...
                <div class="p-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white sticky top-0 z-10">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-xs text-white/80">Rounds 1 - ${halfRounds} | ${CURRENT_LEAGUE === 'laliga' ? 'Premier League' : 'Laliga'}</p>
